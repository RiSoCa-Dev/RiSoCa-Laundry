...
export function OrderForm() {
  ...
  return (
    <>
    <Card className="shadow-lg w-full h-full max-h-full flex flex-col min-h-0">
      <form onSubmit={form.handleSubmit(onOrderSubmit)} className="flex flex-col h-full min-h-0">
        ...
        <CardContent className="space-y-4 p-4 pt-0 flex-1 min-h-0 overflow-y-auto overflow-x-hidden scrollable">
